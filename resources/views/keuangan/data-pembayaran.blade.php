...
@section('content')
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <a href="/requestEdit/pembayaran" data-bs-toggle="tooltip" data-bs-placement="bottom"
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            ...
                            <div class="stat-number text-success mb-4">Rp
                                {{ number_format($cashPayments ?? 0, 0, ',', '.') }}</div>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            ...
                            <div class="stat-number text-primary mb-3">Rp
                                {{ number_format($transferPayments ?? 0, 0, ',', '.') }}</div>
                            <div class="stat-sublabel">Total transaksi</div>
                        </div>
                        <div class="stat-icon bg-danger bg-opacity-10 text-danger">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="flex-grow-1">
                            ...
                            <div class="stat-number text-warning mb-3">Rp
                                {{ number_format($ewalletPayments ?? 0, 0, ',', '.') }}</div>
                            <div class="stat-sublabel">Total transaksi</div>
                        </div>
                        <div class="stat-icon bg-warning bg-opacity-10 text-warning">
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-sm justify-content-center mb-0">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link ajax-pagination-old" href="#"
                                            data-page="{{ $payments->currentPage() - 1 }}">‹ Previous</a>
                                    </li>
                                @endif
                                ...
                                @if ($payments->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link ajax-pagination-old" href="#"
                                            data-page="{{ $payments->currentPage() + 1 }}">Next ›</a>
                                    </li>
                                @else
                                    <li class="page-item disabled">
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select name="tipe_pembayaran" class="form-select" required>
                                            <option value="reguler"
                                                {{ $pembayaran->tipe_pembayaran == 'reguler' ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-12 mb-2">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bx bx-money"></i></span>
                                        <input type="text" name="jumlah" id="jumlah{{ $pembayaran->id }}"
                                            class="form-control"
