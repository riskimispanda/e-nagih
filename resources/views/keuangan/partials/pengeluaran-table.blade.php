  ...
  <tr class="text-center">
    ...
    <td>
      <div class="d-flex gap-2">
        ...
        <button class="btn btn-outline-danger btn-sm mb-1" data-bs-toggle="modal" data-bs-target="#deletePengeluaranModal"
          data-id="{{ $pengeluaran->id }}" title="Hapus" data-bs-placement="bottom">
