  ...
  <div class="page">
    ...
    <div class="header">
      ...
      <div class="invoice-meta">
        ...
        <div class="invoice-number">Invoice #{{ $invoice->customer_id }}</div>
      ...
      <table class="invoice-table">
        ...
        <tbody>
          <tr>
            ...
            <td class="text-left">Rp {{ number_format($invoice->tagihan, 0, ',', '.') }}</td>
          </tr>
          @if($invoice->tambahan > 0)
            <tr>
              <td>Biaya Tambahan</td>
              <td class="text-left">1</td>
              <td class="text-left">Rp {{ number_format($invoice->tambahan, 0, ',', '.') }}</td>
            </tr>
          @endif
      ...
      <table class="summary-table">
        <tr>
          ...
          <td class="summary-value">Rp
            {{ number_format($invoice->tagihan + $invoice->tambahan + $invoice->tunggakan, 0, ',', '.') }}
          </td>
        </tr>
        @if($invoice->saldo > 0)
          <tr>
