...
@section('content')
                ...
                <tbody class="text-center">
                  ...
                  @forelse ($perusahaan as $item)
                    <tr>
                      ...
                      <td>
                        <a href="{{ $item->gps }}" target="_blank" class="btn btn-action btn-maps" data-bs-toggle="tooltip"
                      ...
                      <td>
                        <a href="/corp/detail/{{ $item->id }}">
                          <button type="button" class="btn btn-action btn-edit" data-bs-toggle="tooltip"
              ...
              <tbody class="text-center">
                @forelse ($customer as $c)
                  <tr data-id="{{ $c->id }}" data-name="{{ $c->nama_customer }}"
                    ...
                    <td>
                      <a href="{{ $url }}" target="_blank" class="btn btn-action btn-maps {{ $gps ? '' : 'disabled' }}"
            ...
            <div class="row p-2">
              ...
              <div class="col-md-6 form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="no_identitas" class="form-control" id="add_email" placeholder="1234567890"
                    required>
                </div>
              </div>
              <div class="col-12 form-group">
                <label class="form-label" for="add_alamat">Alamat <span class="text-danger">*</span></label>
                <div class="input-group">
                  <span class="input-group-text"><i class="bx bx-home"></i></span>
                  <textarea name="alamat" id="add_alamat" class="form-control" rows="2"
              ...
              <div class="col-md-6 form-group">
                <label class="form-label" for="add_paket">Paket <span class="text-danger">*</span></label>
                <div class="input-group">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Search sekarang dilakukan server-side (via form GET)
      // Tekan Enter atau klik tombol search untuk mencari
