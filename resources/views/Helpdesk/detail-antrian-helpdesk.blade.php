                ...
                <div class="info-section">
                    ...
                    <div class="info-item">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ $customer->gps }}" target="_blank" class="btn btn-action btn-maps">
                                <i class="bx bx-map"></i>
                            </a>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('update-antrian-helpdesk', $customer->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label" for="edit_status_id">Status</label>
                                <select id="edit_status_id" name="status_id" class="form-select">
                                    @foreach ($status as $s)
                                        <option value="{{ $s->id }}"
                                            {{ $customer->status_id == $s->id ? 'selected' : '' }}>
                                            {{ $s->nama_status }}
                                        </option>
                                    @endforeach
                                </select>
