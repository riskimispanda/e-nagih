                            ...
                            <div class="stats-summary me-4 d-none d-lg-block">
                                <div class="d-flex gap-4">
                                    <div class="summary-item">
                                        ...
                                        <span class="fw-semibold">{{ $perangkat->sum('jumlah_stok') }} Unit</span>
                                    </div>
                                    <div class="summary-item">
                                        <span class="text-muted small d-block">Total Nilai</span>
                                        <span class="fw-semibold text-primary">
                                            Rp {{ number_format($perangkat->sum('harga'), 0, ',', '.') }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                @if (count($perangkat) > 0)
                                    @foreach ($perangkat as $p)
                                        <tr class="device-row">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <i class='bx bx-chip text-muted me-2'></i>
                                                    <span class="fw-medium">{{ $p->nama_perangkat }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <span
                                                    class="badge bg-label-{{ $p->jumlah_stok > 10 ? 'success' : ($p->jumlah_stok > 5 ? 'warning' : 'danger') }}">
                                                    {{ $p->jumlah_stok }} Unit
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="action-btn btn btn-danger btn-sm">
