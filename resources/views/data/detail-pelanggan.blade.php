                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 text-center">
                            <div class="customer-avatar mx-auto">
                                <img src="{{ asset($profile->profile) ?? asset('assets/img/avatars/default.png') }}"
                                    alt="Customer Avatar" class="w-100 h-100 rounded-circle" />
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="info-group">
                                                    ...
                                                    <div class="info-value">
                                                        {{ $customer->lokasi->nama_lokasi ?? 'Tidak ada' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="info-group">
                                                    ...
                                                    <div class="info-value">{{ $customer->remote_address ?? 'Tidak ada' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
