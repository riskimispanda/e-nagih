...
class Analytics extends Controller
{
  ...
  public function logistik()
  {
    ...
    return view("data.data-logistik", [
      ...
      "perangkat" => $perangkat,
      'kategori' => $kategori,
      'availableDevices' => $modemDetails->get(LogistikStatus::TERSEIDA, collect()),
      'maintenanceDevices' => $modemDetails->get(LogistikStatus::MAINTENANCE, collect()),
      'damagedDevices' => $modemDetails->get(LogistikStatus::RUSAK, collect()),
    ]);
  }
